...
const Footer = () => {
  return (
    <footer className="bg-[#FF0B55] text-white">
          ...
          <div className='text-center md:text-left flex flex-col gap-4 justify-between'>
            ...
            <div className='flex flex-col justify-center md:items-start items-center md:text-left lg:text-base text-sm'>
              <div className='flex gap-3 items-center'>
                <FaEnvelope />
                <p>Email: <a href="mailto:editor@ijcbs.com" className=" ">editor@ijcbs.com</a></p>
              </div>
              <div className='flex gap-3 items-center'>
                <FaGlobe />
                <p>Website: <a href="" className=" ">www.ijcbs.com</a></p>
              </div>
              <div className=' p-3 '>
      ...
      <div className='grid lg:grid-cols-3 grid-cols-1  items-center    py-3  '>
        ...
        <div className="text-center md:text-base text-xs">
          <p>© 2025 <span className='hover:underline' > <Link to="/" target='_blank'>IJCBS</Link> </span> . All Rights Reserved.</p>
        </div>
      </div>
    </footer>
  );
